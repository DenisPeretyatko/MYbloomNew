...
namespace BloomService.Web.Infrastructure.Services.Concrete
{
    public class SageApiProxy : ISageApiProxy
    {
        ...
        public SageApiProxy(IRepository repository)
        {
        }
        ...
        {
            var request = new RestRequest(EndPoints.AddEquipmentToWorkOrder, Method.PUT) { RequestFormat = DataFormat.Json };
