namespace BloomService.Web.Managers.Concrete
{
    ...
    public class AssignmentApiManager : AddableEditableEntityApiManager<SageAssignment>, IAssignmentApiManager
    {
        ...
        public override IEnumerable<SageAssignment> Add(string endPoint, PropertyDictionary properties)
        {
        ...
        public override IEnumerable<SageAssignment> Edit(string endPoint, PropertyDictionary properties)
        {
