namespace Sage.WebApi.Infratructure.Mapping
{
    ...
    public class SageWebApiMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            this.CreateMap<WorkOrderItemDbModel, SageWorkOrderItem>()
                .ForMember(dest => dest.WorkOrder, opts => opts.MapFrom(src => src.WRKORDNBR))
                .ForMember(dest => dest.WorkOrderItem, opts => opts.MapFrom(src => src.WRKORDITEM))
                .ForMember(dest => dest.WorkDate, opts => opts.MapFrom(src => src.WORKDATE))
                .ForMember(dest => dest.AccountingDate, opts => opts.MapFrom(src => src.ACCTDATE))
                .ForMember(dest => dest.Equipment, opts => opts.MapFrom(src => src.SYSEQPNBR))
                .ForMember(dest => dest.Employee, opts => opts.MapFrom(src => src.TECHNICIAN))
                .ForMember(dest => dest.Quantity, opts => opts.MapFrom(src => src.QUANTITY))
                .ForMember(dest => dest.UnitSale, opts => opts.MapFrom(src => src.UNITSALE))
                .ForMember(dest => dest.TotalSale, opts => opts.MapFrom(src => src.TOTALSALE))
                .ForMember(dest => dest.TotalCost, opts => opts.MapFrom(src => src.TOTALCOST))
                .ForMember(dest => dest.Description, opts => opts.MapFrom(src => src.DESCRIPTION))
                .ForMember(dest => dest.ItemType, opts => opts.MapFrom(src => src.ITEMTYPE))
                .ForMember(dest => dest.LaborProduct, opts => opts.MapFrom(src => src.LABORPRODUCT))
                .ForMember(dest => dest.Invoice, opts => opts.MapFrom(src => src.INVOICENBR))
                .ForMember(dest => dest.PartsProduct, opts => opts.MapFrom(src => src.PARTSPRODUCT))
                .ForMember(dest => dest.Note, opts => opts.MapFrom(src => src.NOTENBR))
                .ForMember(dest => dest.FlatRate, opts => opts.MapFrom(src => src.FLATRATENBR))
                .ForMember(dest => dest.FlatRateLevel, opts => opts.MapFrom(src => src.FLATRATELEVEL))
                .ForMember(dest => dest.LaborSale, opts => opts.MapFrom(src => src.LABORSALE))
                .ForMember(dest => dest.PartsSale, opts => opts.MapFrom(src => src.PARTSSALE))
                .ForMember(dest => dest.LaborCost, opts => opts.MapFrom(src => src.LABORCOST))
                .ForMember(dest => dest.PartsCost, opts => opts.MapFrom(src => src.PARTSCOST))
                .ForMember(dest => dest.IncludedTax, opts => opts.MapFrom(src => src.INCLUDEDTAX))
                .ForMember(dest => dest.Covered, opts => opts.MapFrom(src => src.QCOVERED))
                .ForMember(dest => dest.DateEntered, opts => opts.MapFrom(src => src.DATEENTER))
                .ForMember(dest => dest.TimeEntered, opts => opts.MapFrom(src => new DateTime() + src.TIMEENTER))
                .ForMember(dest => dest.EnteredBy, opts => opts.MapFrom(src => src.ENTERBY))
                .ForMember(dest => dest.TaxGroup, opts => opts.MapFrom(src => src.TAXGROUP))
                .ForMember(dest => dest.ExemptStatus, opts => opts.MapFrom(src => src.EXEMPTSTATUS))
                .ForMember(dest => dest.SalesTaxAmount, opts => opts.MapFrom(src => src.SALESTAXAMT))
                .ForMember(dest => dest.CostQuantity, opts => opts.MapFrom(src => src.COSTQUANTITY))
                .ForMember(dest => dest.JCJob, opts => opts.MapFrom(src => src.JCJOB))
                .ForMember(dest => dest.JCExtra, opts => opts.MapFrom(src => src.JCEXTRA))
                .ForMember(dest => dest.JCCategory, opts => opts.MapFrom(src => src.JCCAT))
                .ForMember(dest => dest.JCCostCode, opts => opts.MapFrom(src => src.JCCOSTCODE))
                .ForMember(dest => dest.Status, opts => opts.MapFrom(src => src.STATUS))
                .ForMember(dest => dest.UnrecognizedRevenue, opts => opts.MapFrom(src => src.UNRECOGNIZEDREV))
                .ForMember(dest => dest.FlatRateLbrExemptStatus, opts => opts.MapFrom(src => src.FRLABOREXEMPTSTATUS))
                .ForMember(dest => dest.FlatRatePrtExemptStatus, opts => opts.MapFrom(src => src.FRPARTSEXEMPTSTATUS))
                .ForMember(dest => dest.FlatRateLbrTaxGroup, opts => opts.MapFrom(src => src.FRLABORTAXGROUP))
                .ForMember(dest => dest.FlatRatePrtTaxGroup, opts => opts.MapFrom(src => src.FRPARTSTAXGROUP))
                .ForMember(dest => dest.FlatRateLbJCCostCode, opts => opts.MapFrom(src => src.FRLABORJCCOSTCODE))
                .ForMember(dest => dest.FlatRatePtJCCostCode, opts => opts.MapFrom(src => src.FRPARTSJCCOSTCODE))
                .ForMember(dest => dest.FlatRateLbJCCategory, opts => opts.MapFrom(src => src.FRLABORJCCAT))
                .ForMember(dest => dest.FlatRatePtJCCategory, opts => opts.MapFrom(src => src.FRPARTSJCCAT))
                .ForMember(dest => dest.FlatRateLaborTaxAmt, opts => opts.MapFrom(src => src.FRLABORSALESTAXAMT))
                .ForMember(dest => dest.FlatRatePartsTaxAmt, opts => opts.MapFrom(src => src.FRPARTSSALESTAXAMT))
                .ForMember(dest => dest.TotalCost, opts => opts.MapFrom(src => src.TOTALPRCOST))
                .ForMember(dest => dest.UnitSaleUnrecognized, opts => opts.MapFrom(src => src.UNITSALEUNRECOGNIZED));
        }
